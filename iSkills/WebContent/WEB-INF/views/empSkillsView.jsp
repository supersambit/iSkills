...
<html>
   <head>
      <meta charset="UTF-8">
      <title>View Employee Skills</title>
   ...
   <body>
		<div class="container">
		<div class="leftpane">
		<div class="wordart blues">&emsp;<span class="text">Your Skills</span></div>
		<br /><div style="text-align: right; font-family: Courier; color: #4C4A5E; font-size: 15px;"><b>logged in as, <strong>${loggedinUser.getName()}</strong></b></div> <div style="text-align: center; font-family: Arial; color: #4C4A5E; font-size:30px; text-shadow: 0.09em -0.02em 0px #000000;"><strong>Employee Skills View</strong></div><br/>
		<div>
					<div style="font-size:17px; font-family:georgia,serif;">&emsp;<form action="${pageContext.request.contextPath}/skillsPage"><strong><em>&emsp;Personal Details :</em></strong><span style="text-align: center; float: right; font-family: Courier; color: #4C4A5E;">
						<input class="w3-button w3-black w3-round-xxlarge" type="submit" style="font-size:13px" value="Back to Grid" width="300px" />&nbsp;</span></form>
				</div>
					<hr style="width: 20%">
				...
				<div style="text-align: center; font-family: Courier; color: #4C4A5E;">
					<form action="${pageContext.request.contextPath}/home">
						<input class="w3-button w3-black w3-round-xxlarge" height="40px" type="submit" value="Back to home" width="350px" /></form>
				</div>
		</div>
