...
public class SkillSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String msg = null;
        try {
 			userskills = DBUtils.skillSearch(conn, x);
 			if(userskills==null) {
 				msg= "Sorry, nothing matches your search. Please refine your search!";
 			}
